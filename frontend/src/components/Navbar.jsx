...
const Navbar = () => {
  ...
  return (
    <header className="fixed top-0 left-0 w-full bg-gray-900 bg-opacity-90 backdrop-blur-md shadow-lg z-40 transition-all duration-300 boder-b borded-emerald-800">
        ...
        {user && (
         ...
         {isAdmin && (
          ...
          >
            ...
            <span className="hidden sm:inline">Dashborad</span>
          </Link>
         )} 
